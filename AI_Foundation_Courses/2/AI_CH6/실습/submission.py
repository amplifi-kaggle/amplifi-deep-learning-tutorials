...
class BacktrackingSearch():
    ...
    def print_stats(self):
        ...
        if self.optimalAssignment:
            print "Found %d optimal assignments with weight %.1f in %d operations" % \
...
solver.solve(create_chain_csp(4))

print "\nCorrect answer:"
print "The optimal weight should be 1"
print "The number of optimal assignments should be 2" 
print "The total number of operations should be 9"
"""
...
"""
print "\nSolving 8 queens CSP without any heuristics:"
nQueensSolver = BacktrackingSearch()
nQueensSolver.solve(create_nqueens_csp(8))

print "\nCorrect answer:"
print "The optimal weight of 8 queens csp is should be 1.0" 
print "The number of optimal assignments is should be 92"
print "The total number of operations is should be 2057"

print ""
print "Solving 3 queens CSP without any heuristics:"
nQueensSolver = BacktrackingSearch()
nQueensSolver.solve(create_nqueens_csp(3))
...
"""
print "\nSolving 8 queens CSP with MCV heuristic:"
mcvSolver = BacktrackingSearch()
mcvSolver.solve(create_nqueens_csp(8), mcv = True)

print "\nCorrect answer:"
print "The optimal weight of 8 queens csp should be 1.0" 
print "The number of optimal assigments should be 92"
print "The total number of operations should be 1361"
"""

# Problem 1c

"""
print "\nSolving 8 queens CSP with AC-3 algorithm:"
acSolver = BacktrackingSearch()
acSolver.solve(create_nqueens_csp(8), ac3 = True)

print "\nCorrect answer:"
print "The optimal weight should be 1.0"
print "The number of optimal assigments should be 92"
print "The total number of operations should be 769"
print "The first optimal assignment should be found at 21th operation"
"""
...
print "\nSolving CSP [A + B + C = 12 or 13]:"
csp.add_unary_factor(sumVar, lambda n: n in [12, 13])
sumSolver = BacktrackingSearch()
sumSolver.solve(csp)

print "\nCorrect answer:"
print "The number of optimal assigments should be 4"

print "\nSolving CSP [A + B + C = 12]:"
csp.add_unary_factor(sumVar, lambda n: n == 12)
sumSolver = BacktrackingSearch()
sumSolver.solve(csp)

print "\nCorrect answer:"
print "The number of optimal assigments should be 2"
"""
...
"""
print "\nSolving a scheduling CSP (profile3a.txt):"
...
print "\nCorrect answer:"
print "The number of optimal assigments should be 3" 
print "Verifyig correctness..."
...
for assignment in alg.allAssignments:
    ...
    util.verify_schedule(bulletin, profile, sol, False)
"""

# Problem 3b: Unit load

"""
print "\nSolving a scheduling CSP (profile3b.txt):"
bulletin = util.CourseBulletin('courses.json')
...
print "\nCorrect answer:"
print "The number of optimal assigments should be 15"
print "Verifyig correctness..."
for assignment in alg.allAssignments:
    sol = util.extract_course_scheduling_solution(profile, assignment)
    util.verify_schedule(bulletin, profile, sol)
"""